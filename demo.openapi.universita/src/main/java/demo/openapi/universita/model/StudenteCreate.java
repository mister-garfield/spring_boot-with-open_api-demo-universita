...
public class StudenteCreate {
   ...
   */
  public StudenteCreate(String nome, String cognome, String codiceFiscale, SessoEnum sesso, String matricola, String corsoDiLaurea) {
    this.nome = nome;
  ...
  public StudenteCreate nome(String nome) {
    this.nome = nome;
    return this;
  }
  ...
  public StudenteCreate cognome(String cognome) {
    this.cognome = cognome;
    return this;
  }
  ...
  public StudenteCreate codiceFiscale(String codiceFiscale) {
    this.codiceFiscale = codiceFiscale;
    return this;
  }
  ...
  public StudenteCreate sesso(SessoEnum sesso) {
    this.sesso = sesso;
    return this;
  }
  ...
  public StudenteCreate matricola(String matricola) {
    this.matricola = matricola;
    return this;
  }

  /**
   * Codice che identifica lo studente in modo univoco.  Formato dalla lettera S seguito da 6 numeri. 
   * @return matricola
   */
  @NotNull @Pattern(regexp = "^S[0-9]{6}$") @Size(min = 7, max = 7) 
  @Schema(name = "matricola", description = "Codice che identifica lo studente in modo univoco.  Formato dalla lettera S seguito da 6 numeri. ", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public StudenteCreate corsoDiLaurea(String corsoDiLaurea) {
    this.corsoDiLaurea = corsoDiLaurea;
    return this;
  }

  /**
   * Nome del percorso universitario che lo studente sta seguendo.
   * @return corsoDiLaurea
   */
  @NotNull 
  @Schema(name = "corsoDiLaurea", description = "Nome del percorso universitario che lo studente sta seguendo.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("corsoDiLaurea")
  ...
  public boolean equals(Object o) {
    ...
    StudenteCreate studenteCreate = (StudenteCreate) o;
    return Objects.equals(this.nome, studenteCreate.nome) &&
        Objects.equals(this.cognome, studenteCreate.cognome) &&
        Objects.equals(this.codiceFiscale, studenteCreate.codiceFiscale) &&
        Objects.equals(this.sesso, studenteCreate.sesso) &&
        Objects.equals(this.matricola, studenteCreate.matricola) &&
        Objects.equals(this.corsoDiLaurea, studenteCreate.corsoDiLaurea);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nome, cognome, codiceFiscale, sesso, matricola, corsoDiLaurea);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StudenteCreate {\n");
    ...
    sb.append("    corsoDiLaurea: ").append(toIndentedString(corsoDiLaurea)).append("\n");
    sb.append("}");
    return sb.toString();
  }
